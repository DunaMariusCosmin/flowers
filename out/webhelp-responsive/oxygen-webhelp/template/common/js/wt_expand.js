...
$(document).ready(function () {
    ...
    function toggleSubtopics(state) {
        ...
        if (state !== undefined){
            ...
            if (state == 'expanded'){
                ...
                $('.wh_hide_subtopics').attr('data-state','collapsed').removeClass('glyphicon-chevron-down').addClass('glyphicon-chevron-up').attr('title',getLocalization('expandSections'));
                $(this).removeClass('expanded');
            } else {
                siblings.slideDown("1000");
                $('.wh_hide_subtopics').attr('data-state','expanded').removeClass('glyphicon-chevron-up').addClass('glyphicon-chevron-down').attr('title',getLocalization('collapseSections'));
     ...
     */
    $('.wh_hide_subtopics').click(function(){
        var state = $('.wh_hide_subtopics').attr('data-state');
